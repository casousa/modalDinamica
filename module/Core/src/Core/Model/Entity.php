...
abstract class Entity implements InputFilterAwareInterface
{
     ...
     * Adapter for DB.
     * 
     * @var Core\Db\AdapterServiceFactory
     */
    protected $dbAdapter = null;
    
    /**
     * Namespace da model. Utilizada pelo método getTable().
     * 
     * @var string
     */
    ...
    /**
     * Returns a tableName from Model
     *
     * @return string
     */
    ...
    {
        if(is_null($this->dbAdapter) || is_null($this->table)){
            throw new EntityException("Parameters not defined in constructor method.");
        }
        
        $tableGateway = new TableGateway($this->dbAdapter, $this->table, new $this->table);
